...
public class MonatMyWebSite_Methods extends TestBase {
	...
	public void addMyWebsite(String templateName,String websiteName) throws Exception{
		...
		System.out.println("total rows = " +items % 2);
	...
	public void enterOwnerContactDetails(String siteName, String ownerName, String ownerPhone) throws Exception{
		...
		String btnCloseWebsite = prop.getLocatorForEnvironment(appUrl,"btnCloseWebsite");
		...
		clickOnButton("cssSelector", "input.btn.btn-default.btn.btn-primary.pull-right");
