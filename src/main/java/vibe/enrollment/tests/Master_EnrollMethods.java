...
public class Master_EnrollMethods extends TestBase{
	...
	public void addNewProfile(String profileName, String backend) throws Exception{
		...
		waitOnElement("cssSelector","form.simple_form.edit_pyr_core_enrollment_profile > div.pull-right > input.btn.btn-primary");
	...
	// configure Required Fields
		...
		public void setProfileConfigurationDefaultFields() throws Exception{
			...
			/*
			inputTextClear("cssSelector","#pyr_core_enrollment_profile_can_login");
			inputText("cssSelector","#pyr_core_enrollment_profile_can_login",enrollCanLogin_text);
			
			inputTextClear("cssSelector","#pyr_core_enrollment_profile_customer_type");
			inputText("cssSelector","#pyr_core_enrollment_profile_customer_type", enrollCustomerType_text);
			
			inputTextClear("cssSelector","#pyr_core_enrollment_profile_insert_enroller_level_tree");
			inputText("cssSelector","#pyr_core_enrollment_profile_insert_enroller_level_tree", enrollInsertEnrollerLevelTree_text);
			
			inputTextClear("cssSelector","#pyr_core_enrollment_profile_price_type");
			inputText("cssSelector","#pyr_core_enrollment_profile_price_type", enrollPriceType_text);
			
			inputTextClear("cssSelector","#pyr_core_enrollment_profile_sponsor_id");
			inputText("cssSelector","#pyr_core_enrollment_profile_sponsor_id", enrollSponsor_text);
			*/
	...
	// *********************************************************************************************************************************************
		...
		// selectBusinessEnrollMarket For Links Change
		
		public boolean selectBusinessEnrollMarket(String marketName){
			logInfo("inside verifyEnrollMarketIsPresent() method.");
			boolean isMarketFound = false;
		...
		// selectBusinessEnrollMarket For Dropdown Change
		
		/*public void selectBusinessEnrollMarket(String marketName) throws Exception{
			logInfo("inside selectBusinessEnrollMarket() method.");
			
			selectFromDropdown("xpath","//*[@id='enrollment_market_picker']","byVisibleText",marketName);
			clickOnButton("xpath","//*[@id='main-content']/div/div/div[1]/div/button");
		...
		public void acceptTOC() throws Exception{
			...
			waitOnElement("cssSelector","div.checkbox > label > input#pyr_core_v2_enrollment_toc_acceptance.boolean.optional");
			clickOnElement("cssSelector","div.checkbox > label > input#pyr_core_v2_enrollment_toc_acceptance.boolean.optional");
		...
		public boolean verifyEnrollmentSuccessfulAtUser() throws Exception, Exception{
