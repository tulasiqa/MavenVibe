...
public class IDLCalendarMethods extends TestBase {
...
//		Thread.sleep(3000);
		...
		clickOnElement("xpath", idlBtnMoreOptions);
...
//				WebElement e = driver().findElement(By.xpath("//*[@id='contact-lists']/div[@class='contact media row'][1]"));
