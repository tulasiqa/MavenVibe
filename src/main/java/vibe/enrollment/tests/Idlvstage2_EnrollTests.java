...
@Priority(32)
public class Idlvstage2_EnrollTests extends Idlvstage2_EnrollMethods {
	Logger logger = Logger.getLogger(Idlvstage2_EnrollMethods.class);
...
*/
		...
		@Test(priority =2304)
		public void createHhouseHoldCustomerFrom() throws Exception{	
