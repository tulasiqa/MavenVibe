...
@Priority(39)
public class IDLSettings_Tests extends IDLSettingsMethods {
	...
	public void verifyAccountInformation() throws Exception{
		...
		if(isVerified){
			updateAccountInfo(prop.getLocatorForEnvironment(appUrl,"newsFN3"),prop.getLocatorForEnvironment(appUrl,"newsLN3"),"icentris.qa6+908406@gmail.com","Salt Lake City");
		}
		else{
