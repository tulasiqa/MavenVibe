...
public class CalendarMethods extends TestBase {
	...
	public void addNewCalendarEvent(String eventName, String startDate, String endDate, String inviteeName) throws Exception{
		try{
...
//		Thread.sleep(6000);
	...
	public void addAlldayCalendarEvent(String eventName, String startDate, String endDate, String inviteeName) throws Exception{
	...
	public void addRepeatCalendarEvent(String eventName, String startDate, String endDate, String inviteeName) throws Exception{
		...
		inputTextClear("xpath",inputEventEndDate);
		inputText("xpath",inputEventEndDate,endDate);
		selectRadioOrCheckbox("cssSelector",chkRepeat);
		optionsRepeatEventDialog("Daily" , "No End Date");
	...
	public void addQuickCalendarEvent(String eventName, String startDate, String endDate) throws Exception{
		...
		inputText("xpath",inputEventEndDate,endDate);
		/*Thread.sleep(10000);
		waitOnElement("xpath",".//*[@id='event_form']/div[4]/div/div[@class='view-actions']/input");
		clickOnElement("xpath",".//*[@id='event_form']/div[4]/div/div[@class='view-actions']/input");
		*/
		//waitOnElement("xpath","//*[@class='view-actions']/input[@value='Save']");
		//clickOnElement("cssSelector","#submit-form");
		waitOnElement("xpath",btnEventSave);
		clickOnButton("xpath",btnEventSave);
//		Thread.sleep(5000);
		/*waitOnElement("xpath","//*[@class='view-actions']/input");
		clickOnElement("xpath","//*[@class='view-actions']/input");*/
	}
...
//			Thread.sleep(3000);
	...
	public void go2CalendarPage() throws Exception {
		...
		Thread.sleep(5000);
		waitOnElement("xpath","//div[@class='fc-left']/button[3]");
		clickOnElement("xpath","//div[@class='fc-left']/button[3]");
		Thread.sleep(5000);
	}
...
//		Thread.sleep(5000);
	...
	public void addCorpCalendarEvent(String eventName, String startDate, String endDate, String inviteeName) throws Exception{
...
//			Thread.sleep(3000);
			...
			for(WebElement x: allElements){
				...
				if(event.equalsIgnoreCase(eventName)){		
					...
					isMatchFound = true;
					 ...
					 waitOnElement("xpath","//button[contains(text(),'Settings')]");
					 clickOnElement("xpath","//button[contains(text(),'Settings')]");
					 clickOnElement("xpath","//ul[@class='dropdown-menu']/li[1]/a[2]");
	...
	*/	
	 ...
	 public void deleteCalendarEvent(String eventName) throws Exception, Exception{
			System.out.println("inside deleteCalendarEvent() method.");
			logInfo("inside deleteCalendarEvent() method.");
	 ...
	 public void verifyCalenderEventInAllViews(String eventName) throws Exception{
		 ...
		 for(WebElement x : allButtons){
			...
			case "Day":
				...
				waitOnElement("xpath", calendarDayViewPane);	
...
//						Thread.sleep(4000);		
						waitOnElement("cssSelector",bodyText);
	   ...
	   public void calenderToolBar(String toolItem) throws Exception{
		   ...
		   waitOnElement("cssSelector",caltoolBar);
	...
	public void verifyNewInvitees(String guestType, String eventName) throws Exception{
		...
		if (mails.size()==0){		 
			...
			for(int j=1;j<=mails.size();j++){
				WebElement e = driver().findElement(By.xpath("//*[@id='contact-lists']/div[@class='contact-list']/div/div[@class='contact media row'][1]/div[@class='media-right']/input"));
				e.click();
				break;
			}
		}
...
//		 Thread.sleep(5000);
	...
	public void verifyAdvancedSearchWithOptions(boolean eventType, boolean country, boolean state) throws Exception, Exception{
		...
		System.out.println("inside verifyAdvancedSearchWithOptions() method.");
		waitOnElement("xpath",btnSearch);
		clickOnElement("xpath",btnSearch);
		waitOnElement("linkText","Advanced Search");
		clickOnElement("linkText", "Advanced Search");
...
//		Thread.sleep(2000);
	...
	public boolean checkUpcomingEventsCount(String eventName) throws Exception, Exception{
		System.out.println("inside checkUpcomingEventsCount() method");
		logInfo("inside checkUpcomingEventsCount() method...");
		boolean isVerified = false;
