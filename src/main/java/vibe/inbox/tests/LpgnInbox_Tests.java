...
@Priority(4)
 public class LpgnInbox_Tests extends LpgnInboxMethods {

	 public static String vibeRecipient_text = getEmail(adminUser1_text,appUrl);  // "icentris.qa6+1018550@lpgn-prod.vibeoffice.com"; // getEmail(adminUser_text,appUrl); 
...
//	 public static String vibeRecipient_text =  "kevin.mcevoy@branch-1-11.vibeoffice.com";
     ...
     @Test(priority=401)
  		...
  		public void sendEmailFromGmail() throws Exception{
            ...
            System.out.println(selfmailId);
  			...
  			composeGmail(vibeRecipient_text,composeSubject_text,composeDesc_text);
  			signoutGmail();
  			//logIn(prop.getLocatorForEnvironment(appUrl,"User"),prop.getLocatorForEnvironment(appUrl,"Passwd"));
	...
	public void markEmailAsStarred() throws Exception{
		...
		System.out.println("vibeRecipient_text = " +vibeRecipient_text);
		composeVibeEmail(vibeRecipient_text,txtStarVibeEmailSubject);  
	...
	public void markEmailAsImportant() throws Exception{
		...
		composeVibeEmail(vibeRecipient_text,txtImpVibeEmailSubject);  
		boolean isMailPresent = false;
