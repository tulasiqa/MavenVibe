...
@Priority(2)
public class AVBusinessContacts_Tests extends AVBusinessContactsMethods {
	...
	//This testcase is to verify the user details by filtering from filters
	@Test(priority=202)
	public void AdvancedFfilterSearch() throws Exception {		
		logInfo("inside filterSearchforRep() test");
		go2Contacts();
		filtersSearchAndValidatingData();
	...
	public void sendEcard2BusinessContact() throws Exception{
		...
		System.out.println("inside sendEcard2BusinessContact() Test");
		loginAsUserFromAdvanced(prop.getLocatorForEnvironment(appUrl,"newsFN1"),prop.getLocatorForEnvironment(appUrl,"newsLN1"),
                prop.getLocatorForEnvironment(appUrl,"newsCon1"));
		
		sendecard2Contacts(contactFirstName_text,contactLastName_text);
		/*if(isNotesFound==false){
	...
	public void sendMesg2BusinessContact() throws Exception{
		...
		logOutInAvon();		
		in.loginGmail(gmailId_text2, gmailPwd_text2);		
