...
@Priority(32)
public class EnrollTests extends EnrollMethods {
	Logger logger = Logger.getLogger(EnrollTests.class);
	
	 String market = "United States";
	 String profileName = "Profile" + TestBase.generateRandomNumberInRange(1, 999); 
	 String[] enrollProfileConfigFields={"Can login","Customer type","Insert enroller level tree", "Price type","Sponsor", "Subscription with promotion"}; // master
	 String enrollSponsor_text = "813619";
