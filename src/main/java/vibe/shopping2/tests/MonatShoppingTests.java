...
@Priority(114)
public class MonatShoppingTests extends Shopping2Methods{
	...
	public void placeOrderProducts() throws Exception{		
		...
		//existingUserCredentials("viber.1206");
		nav2CustShopping();		
		searchItembyNameOrSku(txtVirtualProdName11);
		addQuanityNdCheckOutInMonat(2);
