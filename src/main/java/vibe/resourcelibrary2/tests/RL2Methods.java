...
public class RL2Methods extends TestBase{
	  ...
	  public void navigate2UserRL() throws IOException, Exception{
		...
		public void addNewResource(String resName,String pCategory, String resStatus, boolean resPublish, boolean isResNewest,String fileType) throws Exception{
			...
			if(resPublish==true){
				...
				inputText("xpath",inputPublishDate,"12/12/2017");
		...
		public void addResourceThumbnail() throws Exception{
			...
			//clickOnElement("cssSelector",inputBrowseThumbnail);
		...
		public void selectRankDefs() throws Exception{
			...
			for(int i=1;i<=cntRanks;i++){
				...
				if(rankName.equalsIgnoreCase(rankdeflist[j]) ){  // && isSelected.equalsIgnoreCase("false")
					...
					/*WebElement endDate = driver().findElement(By.xpath(before_enddate+i+after_enddate));					
					endDate.click();
					waitOnElement("xpath","//a[@data-action='close']/span");
					clickOnElement("xpath","//a[@data-action='close']/span");*/
		...
		public void selectCategoryFilter(String categoryName) throws Exception, Exception{
			...
			e.click();
			waitOnElement("xpath","//div[@id='categories_id_container']/ul");
		...
		public void deleteResourceAdmin(String resName) throws Exception, Exception{
			...
			List tblRes = driver().findElements(By.xpath("//*[@id='resource-table']/tbody"));
		
			String before_name = "//*[@id='resource-table']/tbody[";
			String after_name = "]/tr/td[2]/a";
			
			String before_btn = "//*[@id='resource-table']/tbody[";
			String after_btn = "]/tr/td[7]/div/div/div/button";
			
			String before_delete = "//*[@id='resource-table']/tbody[";
			String after_delete = "]/tr/td[7]/div/div/div/ul/li[3]/a";
			
			for(int i=1;i<=tblRes.size();i++){
		...
		public void deleteResourceAdminListView(String resName) throws Exception, Exception{
			logInfo("inside deleteResourceAdmin() method.");
			System.out.println("inside deleteResourceAdmin() method.");
			Thread.sleep(5000);
		
			waitOnElement("xpath",resourcesTableAdmin);
			List<WebElement> rows = driver().findElements(By.xpath(resourcesTableAdmin));
			int rowsCnt = rows.size();
					
			String before_res_row = "//*[@id='resource-table']/tbody[";
			String res_row = "]";
			String after_res_row ="/tr/td[2]/a";
			
			String moreOptions = "/tr/td[7]/div/div/div/button";
			String deleteOption = "/tr/td[7]/div/div/div/ul/li[3]";
			
			
			for(int i=1; i<=rowsCnt; i+=2){					
					WebElement res = driver().findElement(By.xpath(before_res_row+i+res_row+after_res_row));
					if (res.getText().equalsIgnoreCase(resName)){	
								driver().findElement(By.xpath(before_res_row+i+res_row+moreOptions)).click();
								driver().findElement(By.xpath(before_res_row+i+res_row+deleteOption)).click();
								confirmBootboxYes();
						break;
					 }
			}
		...
		public boolean selectResource(String resource) throws Exception, Exception{
			...
			String before_res_row = "//*[@id='index_page']/div[";
			String res_row = "]/div/div[";
			String after_res_row = prop.getLocatorForEnvironment(appUrl,"after_res_row");
			
			String before_view_file = "//*[@id='index_page']/div[";
			String view_file = "]/div/div[";
			String after_view_file = prop.getLocatorForEnvironment(appUrl,"after_view_file");
...
//						waitOnElement("xpath",viewRes);
		...
		public boolean selectResourceListView(String resource) throws Exception, Exception{
			logInfo("inside selectResource() method to view the resource."); 
			boolean isResourcePresent = false;	
			waitOnElement("xpath",resourcesTableAdmin);
			List<WebElement> rows = driver().findElements(By.xpath(resourcesTableAdmin));
	...
	public boolean downloadAssetForResource(String resourceName) throws Exception, Exception{
		...
		String resAfter = prop.getLocatorForEnvironment(appUrl,"resAfter");
		...
		waitOnElement("cssSelector",".ic-icon-download");
		clickOnElement("cssSelector",".ic-icon-download");
		implicityWaits(5);
	...
	public boolean searchResourceListView(String resourceText) throws Exception{
		logInfo("Inside searchResource() method.");
		boolean isResourceFound = false;
		waitOnElement("xpath", txtSearchResource);
		inputTextClear("xpath", txtSearchResource);
		inputText("xpath", txtSearchResource, resourceText);
		Thread.sleep(5000);
		List <WebElement> resources = driver().findElements(By.xpath(prop.getLocatorForEnvironment(appUrl,"ResourcesTable")));
		 int resourcesCount = resources.size();
			System.out.println(resourcesCount +"are the resources in the table");
			String before =  prop.getLocatorForEnvironment(appUrl,"beforeList");
					String after =  prop.getLocatorForEnvironment(appUrl,"afterList");
			
			for(int i=1;i<=resourcesCount;i++){
				waitOnElement("xpath",before+i+after);
				 WebElement res = driver().findElement(By.xpath(before+i+after));
				 if (res.getText().trim().contains(resourceText)){				 
					 isResourceFound = true;
	...
	public boolean displayResourceInListView(String resourceName) throws Exception{
  	...
  	public boolean previewResourceGridView(String resourceName) throws Exception, Exception{
    logInfo("Entered into previewResource()(String resourceName) method");
    System.out.println("Entered into previewResource() method");
    boolean isResourceFound= false;          
    System.out.println(isResourceFound  +"Before previewing the resource");
	waitOnElement("cssSelector",resourceItems);
	List <WebElement> resources = driver().findElements(By.cssSelector(resourceItems));
	...
	for(int i=1;i<=resources.size();i++){
	 ...
	 if (isResourceFound ==false){
	     Assert.assertTrue(isResourceFound, resourceName +" is not available in Grid");         
	            }
	return isResourceFound;
	}
	...
	public boolean previewResourceListView(String resourceName) throws Exception, Exception{ 
		 logInfo("Entered into previewResourceListView() method");
		 System.out.println("Entered into previewResourceListView() method");
		    boolean isResourceFound= false;         
		    
		    waitOnElement("xpath",prop.getLocatorForEnvironment(appUrl,"ResourcesTable"));
		    List<WebElement> resources = driver().findElements(By.xpath(prop.getLocatorForEnvironment(appUrl,"ResourcesTable")));
		    int resourcesCount = resources.size();
			System.out.println(resourcesCount +"are the resources in the table");
			...
			String before = prop.getLocatorForEnvironment(appUrl,"beforeList");
			String after = prop.getLocatorForEnvironment(appUrl,"afterList");
			 System.out.println("expected res = " + resourceName);
			for(int i=1;i<=resourcesCount;i++){
				waitOnElement("xpath",before+i+after);
				 WebElement res = driver().findElement(By.xpath(before+i+after));
				 System.out.println("actual res = " + res.getText().trim());
				 
				 if (res.getText().trim().equalsIgnoreCase(resourceName)){		
					 res.click();
					 System.out.println("clicked on the resource");
	...
	/*public boolean previewResourcedfhfg(String resourceName) throws Exception{
		...
		String resBefore = prop.getLocatorForEnvironment(appUrl,"previewresBefore");                                                                                                                                
		String resAfter = 	prop.getLocatorForEnvironment(appUrl,"previewresAfter");																																																	 
	...
	public boolean composeEmailAsAttachment(String resourceName,String parentCategory) throws Exception{
		...
		previewResourceListView(resourceName);
...
/*		 ( ( JavascriptExecutor ) _driver )
	...
	public boolean verifyParentCategory(String parentCategory) throws Exception{  
        logInfo("inside verifyParentCategory1() method.");
        boolean isMatchFound = false;
       
        String resourcePanelCategory = "//*[@id='main-content']/div/div[2]/ul/li[@class!='active']";
        String categoryName;
        WebElement category;
        waitOnElement("xpath",resourcePanelCategory);
        ...
        String before = "//*[@id='main-content']/div/div[2]/ul/li[@class!='active'][";
        String after = "]/a";
        for(int i=1;i<=categories.size();i++){
            waitOnElement("xpath",before+i+after);
            ...
            Assert.assertTrue(isMatchFound,parentCategory+" parent cat is not found" );
        }
        return isMatchFound;
   }
...
/*	public void selectParentAndChildCategory(String parentCategory, String childCategory) throws Exception{
	...
	public void shareResourceByEmail(String resource,String mailID) throws Exception, Exception{
		logInfo("Select Resource control like -Details, Share, Email  to foucs on it.");
		System.out.println("Inside shareResourceByEmail() method.");
		waitOnElement("xpath","//*[@id='page']/div[4]/div/div/div[2]/div[2]/div/div[2]");
		
		waitOnElement("cssSelector",prop.getLocatorForEnvironment(appUrl,"shareEmailIcon"));
		clickOnElement("cssSelector",prop.getLocatorForEnvironment(appUrl,"shareEmailIcon"));
		composeNSend(mailID);	
	...
	public  void shareToCommunity() throws Exception{
		logInfo("Inside shareToCommunity() method"); 
		System.out.println("Inside shareToCommunity() method");
		waitOnElement("xpath",btnOptions);
		clickOnElement("xpath",btnOptions);
		waitOnElement("xpath",lnkPost2Community);
		clickOnElement("xpath",lnkPost2Community);
	...
	public boolean shareToMyWebsite(String assetTitle) throws Exception{
		...
		waitOnElement("cssSelector",prop.getLocatorForEnvironment(appUrl,"sharePwp"));
		clickOnElement("cssSelector",prop.getLocatorForEnvironment(appUrl,"sharePwp"));
	 ...
	 public boolean handleMyWebsite(String resourceAsset) throws Exception{
		...
		for(String w : driver().getWindowHandles()){
			if(!w.equalsIgnoreCase(wndBeforeWindow)){
				...
				System.out.println(resourceAsset +"is thee expected name");
				waitOnElement("cssSelector",pwpAssetShareTitle);
				String resAsset = driver().findElement(By.xpath(txtAsset)).getText();
				System.out.println(resAsset +"is the shared asset");
				if(resAsset.contains(resourceAsset)){
					isAssetFound = true;
    ...
    public void composeNSend(String mailId) throws Exception{
		...
		confirmationMessage("This resource has been sent to: "+mailId);
		Thread.sleep(5000);
		waitOnElement("xpath","//*[@id='page']/div[8]/div/div/div[2]/div[1]/div[2]/div/button");
		clickOnElement("xpath","//*[@id='page']/div[8]/div/div/div[2]/div[1]/div[2]/div/button");
		Thread.sleep(5000);
    }
...
//			uploadFile("Text");
			uploadFile("Text",btnNewResourceIconBrowse);
			clickOnLink("linkText","Next");
			clickOnButton("cssSelector",btnCreateNewResource);
		...
		public boolean verifyAssetValidationsAdd() throws Exception, Exception{
			...
			if(isValidationsVerified){
				if(assetTypePDF.equals("PDF")){
					/*clickOnElement("cssSelector",inputAssetPath);
					uploadFile("Text");*/
					uploadFile("Text",inputAssetPath);
					waitOnElement("cssSelector",validateAssets);
					WebElement fileType= driver().findElement(By.cssSelector(validateAssets));
...
//			clickOnLink("linkText","Next");
		...
		*/
		...
		public void updateProductAssets(String assetTitle) throws Exception, Exception{
	    	...
	    	/*clickOnElement("xpath",browseDocument);
	    	uploadFile("PDF");*/
