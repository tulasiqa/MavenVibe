...
public class Calendar_Tests extends CalendarMethods {
	...
	public void createAllDayCalendarEvent() throws Exception{
		System.out.println("inside AlldayEvent() Test");
		go2CalendarPage();
		addAlldayCalendarEvent(allDayEventName_text, allDayEventStartdate_text, allDayEventEnddate_text);
		go2CalendarPage();
	...
	public void searchAllDayCalendarEvent() throws Exception{
		System.out.println("inside searchAllDayCalendarEvent() Test");
		go2CalendarPage();
		...
		if(isMatchFound==true){
			...
			Assert.assertTrue(isMatchFound, allDayEventName_text + " Allday calendar event match found.");
		} else {
	...
	public void updateAllDayCalendarEvent() throws Exception{
		System.out.println("inside updateAllDayCalendarEvent() Test");
		go2CalendarPage();	
	...
	public void deleteAllDayCalendarEvent() throws Exception{
		System.out.println("inside deleteAllDayCalendarEvent() Test");
		go2CalendarPage();
		deleteCalendarEvent("Allday Event",allDayEventName_updtext);
//		Thread.sleep(10000);
		boolean isMatchFound = searchCalendarEvent(allDayEventName_updtext);
		if(isMatchFound==true){
			logInfo(allDayEventName_updtext + " could not be deleted.");
			Assert.assertTrue(isMatchFound, allDayEventName_updtext + " could not be deleted.");
		}
	}	
	...
	public void searchRepeatCalendarEvent() throws Exception{
		System.out.println("inside searchRepeatCalendarEvent() Test");
		go2CalendarPage();
		...
		if(isMatchFound==true){
			...
			Assert.assertTrue(isMatchFound, repeatEventName_text + " Repeat calendar event match found.");
		} else {
	...
	public void updateRepeatCalendarEvent() throws Exception{
		System.out.println("inside updateRepeatCalendarEvent() Test");
		go2CalendarPage();
	...
	public void deleteRepeatCalendarEvent() throws Exception{
			...
			go2CalendarPage();
			deleteCalendarEvent("Repeat Event",repeatEventName_text); //repeatEventName_updtext
			userLogout();
		}
		catch(Exception ex){
			userLogout();
	...
	public void createQuickCalendarEvent() throws Exception{
		System.out.println("inside quickCalendarEvent() Test");
		go2CalendarPage();
	...
	public void searchQuickCalendarEvent() throws Exception{
		System.out.println("inside searchQuickCalendarEvent() Test");
		go2CalendarPage();
		boolean isMatchFound = searchCalendarEvent(quickEventName_text);
		if(isMatchFound==true){
			logInfo(quickEventName_text + " Quick calendar event match found.");
			Assert.assertTrue(isMatchFound, quickEventName_text + " Quick calendar event match found.");
		} else {
	...
	public void updateQuickCalendarEvent() throws Exception{
		System.out.println("inside updateQuickCalendarEvent() Test");
		go2CalendarPage();
	...
	public void deleteQuickCalendarEvent() throws Exception{
		System.out.println("inside deleteQuickCalendarEvent() Test");
		go2CalendarPage();
		deleteCalendarEvent("Quick Event",quickEventName_updtext);
		/*Thread.sleep(10000);*/
		boolean isMatchFound = searchCalendarEvent(quickEventName_updtext);
		if(isMatchFound==true){
			logInfo(quickEventName_updtext + " could not be deleted.");
			Assert.assertTrue(isMatchFound, quickEventName_updtext + " could not be deleted.");
		}
	}	
	...
	public void searchCorpCalendarEvent() throws Exception{
		System.out.println("inside searchCorpCalendarEvent() Test");
		go2CorporateCalendarPage();
		verifyEventisDisplayed(corpEventName_text);
		back2Office();
	}
	...
	public void updateCorpCalendarEvent() throws Exception{
		System.out.println("inside updateCorpCalendarEvent() Test");
		go2CorporateCalendarPage();
	...
	public void createNewEventwithPastDate() throws Exception{
		System.out.println("inside createNewEventwithPastDate() Test");
	...
	public void createNewEventwithFutureDate() throws Exception{
		System.out.println("inside createNewEventwithFutureDate() Test");
		...
		System.out.println("isMatchFound =" +futEventName_text);
		if(isMatchFound==false){
			logInfo(futEventName_text + " calendar event not created for the past date events..");
			Assert.assertFalse(isMatchFound, futEventName_text + " calendar event not created for the past date events.");
		}
	}
	...
	public void inviteGroups() throws Exception{
		...
		System.out.println(EventMeeting);
		go2CalendarPage();
	...
	public void verifyContactList() throws Exception{	
		...
		System.out.println(EventMeeting2);
		go2CalendarPage();
...
//		String selfmailId  = getEmail(adminUser_text, appUrl);
	...
	public void deleteListCalendarEvent() throws Exception{	
		...
		go2CalendarPage();		
		deleteCalendarEvent("Quick Event",EventMeeting2);
//		Thread.sleep(10000);
	...
	public void verifyNewInviteesSectionEdit() throws Exception{
		...
		System.out.println("inside verifyNewInviteesSectionEdit() Test.");
		go2CalendarPage();
	...
	public void verifyEventLinkFromEmail() throws Exception{
		...
		System.out.println("inside verifyEventLinkFromEmail() Test.");
		go2CalendarPage();
	...
	public void verifyDismissedCorporateEvent() throws Exception{
		...
		System.out.println("inside verifyDismissedCorporateEvent() Test");
		go2CorporateCalendarPage();
		addCorpCalendarEvent(corpEventName_text, corpEventStartdate_text, corpEventEnddate_text);
		back2Office();
		logOut();
	...
	public void verifyStatesOnAdvancedSearch() throws Exception{
		...
		System.out.println("inside verifyStatesOnAdvancedSearch() Test.");
		go2CalendarPage();
...
//		Thread.sleep(3000);
	...
	public void verifyBackFromEventDetails() throws Exception{
		...
		System.out.println("inside verifyBackFromEventDetails() Test.");
		go2CalendarPage();
	...
	public void verifyListViewEvent() throws Exception{
		...
		System.out.println("inside verifyListViewEvent() Test.");
		go2CalendarPage();
	...
	@Test(priority=350)
	public void verifyCorporateDefaultOptions() throws Exception{
		logInfo("inside verifyCorporateDefaultOptions() Test.");
		System.out.println("inside verifyCorporateDefaultOptions() Test.");
		go2CorporateCalendarPage();
	...
	public void validateCalendarEvent() throws Exception{
		...
		System.out.println("inside validateCalendarEvent() Test.");
		go2CalendarPage();
	...
	public void deleteEventFromMoreOptions() throws Exception{
		...
		System.out.println("inside deleteEventFromMoreOptions() Test.");
		go2CalendarPage();
		createEventWithMoreOptions(EventMeeting4, newEventStartdate_text, newEventEnddate_text);	
//		deleteEventFromEditPage();
	...
	public void verifyBackFromMoreOptions() throws Exception{
		...
		System.out.println("inside verifyBackFromMoreOptions() Test.");
		go2CalendarPage();
		createEventWithMoreOptions(EventMeeting3, newEventStartdate_text, newEventEnddate_text);	
	...
	public void verifyGuestInvitationMail() throws Exception{
		...
		System.out.println("inside verifyGuestInvitationMail() Test.");
	...
	public void validateSearchCalendarEvent() throws Exception{
		...
		System.out.println("inside validateSearchCalendarEvent() Test.");
		go2CalendarPage();
	...
	public void sortEventsByType() throws Exception{
		...
		System.out.println("inside sortEventsByType() Test.");
		go2CalendarPage();
	...
	public void SearchCalendarEventListView() throws Exception{
		...
		System.out.println("inside SearchCalendarEventListView() Test.");
		go2CalendarPage();
	...
	public void validateSearchCalendarEventListView() throws Exception{
		...
		System.out.println("inside validateSearchCalendarEventListView() Test.");
		go2CalendarPage();
	...
	public void verifyEventByFilterTypes() throws Exception{
		...
		System.out.println("inside verifyEventByFilterTypes() Test.");
		go2CalendarPage();
	...
	@Test(priority=361)
 	...
 	public void corpVerifyInviteGroups() throws Exception{	
	 	...
	 	System.out.println(corpEventMeeting);
	 	go2CorporateCalendarPage();	
 	...
 	public void corpVerifyEventTypeBySorting() throws Exception, Exception {
	 	...
	 	System.out.println(corpListEventProduct);
	 	go2CorporateCalendarPage();
	 	calenderToolBar("List");
 	...
 	@Test(priority=369)
	public void loginAsAdminFromCalendar() throws Exception{
