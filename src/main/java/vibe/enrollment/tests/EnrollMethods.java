...
public class EnrollMethods extends TestBase{
	...
	// configure Required Fields
		...
		*/
		...
		//	waitOnElement("xpath","//*[@class='simple_form edit_pyr_core_enrollment_profile']/div[@class='col-md-12']");
			...
			waitOnElement("cssSelector","#pyr_core_enrollment_profile_can_login");
			inputTextClear("cssSelector","#pyr_core_enrollment_profile_can_login");
			inputText("cssSelector","#pyr_core_enrollment_profile_can_login",enrollCanLogin_text);
			...
			inputTextClear("cssSelector","#pyr_core_enrollment_profile_subscription_with_promotion");
			inputText("cssSelector","#pyr_core_enrollment_profile_subscription_with_promotion", enrollSubscriptionWithPromotion_text);
