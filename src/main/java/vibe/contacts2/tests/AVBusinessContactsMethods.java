...
public class AVBusinessContactsMethods extends TestBase {
	Logger logger = Logger.getLogger(AVBusinessContactsMethods.class);
	...
	public void go2ContactsPage() throws Exception{
		...
		////Thread.sleep(3000);
		waitOnElement("partialLinkText","Recently Viewed Contacts (");
		clickOnLink("partialLinkTextlinkText","Recently Viewed Contacts (");
		
		Thread.sleep(5000);
	}
	

	public void go2Contacts() throws Exception{
		logInfo("inside go2ContactsPage() method. ");
		driver().navigate().to(appUrl + "crm/contacts/manager");
	...
	*/
	...
	/*public void composeText2CallScript()throws IOException, AWTException {
	 ...
	 public void submitNotes() throws Exception {
		 ...
		 waitOnElement("cssSelector",avbtnCreateContactNote);  //changed btnCreateContactNote locator to avlocator nov 16th
		 clickOnButton("cssSelector",avbtnCreateContactNote); //changed btnCreateContactNote locator to avlocator  nov 16th
...
*/ 
	...
	//This testcase is to do a filter search with valid data and verifying the results
 	public void filtersSearchAndValidatingData() throws Exception, Exception {
