...
@Priority(32)
public class IdLife2_EnrollTests extends IdLife2_EnrollMethods {
	Logger logger = Logger.getLogger(IdLife2_EnrollMethods.class);
...
*/
		@Test(priority =2304)
			public void createHhouseHoldCustomerFromMemberAssociate() throws Exception{	
			logInfo("inside createHhouseHoldCustomerFromMemberAssociate test");
				//	 logIn(idlvMAUserName,idlvMAPassword);
				//	 logOut();
				userLogin(prop.getLocatorForEnvironment(appUrl,"MAUser"),prop.getLocatorForEnvironment(appUrl,"MAPasswd"));
				houseHoldCustomer();
		...
		@Test(priority =2305)
		public void createHhouseHoldCustomerFromIndependentAssociate() throws Exception{	
			logInfo("inside createHhouseHoldCustomerFromIndependentAssociate test");
			//logIn(idlvMAUserName,idlvMAPassword);
			//logOut();
			userLogin(prop.getLocatorForEnvironment(appUrl,"MAUser"),prop.getLocatorForEnvironment(appUrl,"MAPasswd"));
			houseHoldCustomer();
		...
		@Test(priority=2306)
		public void loginAsAdminFromEnrollment() throws Exception{
			logInfo("inside loginAsAdminFromEnrollment() Test");
