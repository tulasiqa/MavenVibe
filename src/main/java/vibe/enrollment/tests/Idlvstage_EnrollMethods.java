...
public class Idlvstage_EnrollMethods extends TestBase{
	...
	// *********************************************************************************************************************************************
		...
		public void idlifeEnrollPersonalInformation() throws Exception, Exception{
			...
			inputText("cssSelector",eConfirmEmail,"vibe.icentris@gmail.com");
			selectFromDropdown("cssSelector",eGender,"byVisibleText","Male");
			inputText("cssSelector",eBirthDay,"12/12/1991");
			inputText("cssSelector",eSt1,"Alaska");
			inputText("cssSelector",ePost,"411001");
			inputText("cssSelector",eCity,"Alaska");
			inputText("cssSelector",eState,"Alaska");
		...
		public void idlifeEnrollLoginInformation() throws Exception, Exception{
			...
			String uname = "idlife"+TestBase.random();
			String confirmuname = uname;
			
			waitOnElement("cssSelector",eUserName);
			inputText("cssSelector",eUserName,uname);
			inputText("cssSelector",eConfirmUserName,confirmuname);
		...
		public void idlifeSubmitOrder() throws Exception, Exception{
			...
			/*
			waitOnElement("id","pyr_core_v2_enrollment_shipping_method_1");
			...
			scrollDown("cssSelector","div#accordion > div:nth-child(7) > div:nth-child(2) >   form > div.row > div.col-md-12.clearfix > div.continue > a.btn.btn-primary.btn-enrollment-continue");
			clickOnElement("cssSelector","div#accordion > div:nth-child(7) > div:nth-child(2) >   form > div.row > div.col-md-12.clearfix > div.continue > a.btn.btn-primary.btn-enrollment-continue");
			Thread.sleep(10000);
		...
		public void verifyEnrollmentIsSuccessful() throws Exception, Exception{
			...
			if(actMsg.contains("Congratulations! Your enrollment was successful")){
				logInfo("Enrollment is Successful");
			} else {
				logInfo("Enrollment is NOT Successful");
				Assert.assertTrue(actMsg.contains("Congratulations! Your enrollment was successful"), "Enrollment is NOT successful.");
			}
	}
		...
		public void houseHoldCustomer() throws Exception{	
			...
			clickOnLink("linkText", "Add Household Customer - US");
			...
			selectFromDropdown("cssSelector",enrollGender,"byIndex","1");
		...
		public void houseHoldCustomerMA() throws Exception{	
			logInfo("inside houseHoldCustomer() method.");
			...
			selectFromDropdown("cssSelector",enrollGender,"byIndex","1");
			inputTextClear("cssSelector",enrollUserName);
			inputText("cssSelector",enrollUserName,txtEnrollUserName7);
			inputTextClear("cssSelector",enrollPassword);
			inputText("cssSelector",enrollPassword,txtEnrollPassword);
			inputText("cssSelector",enrollConfirmPassword,txtEnrollPassword);
			waitOnElement("cssSelector",inputTOC);
