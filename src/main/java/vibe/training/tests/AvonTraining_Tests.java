...
@Priority(10)
public class AvonTraining_Tests extends MonatTrainingMethods {
	...
	public void completeSingleTraining() throws Exception{
		...
		loginAsUserFromAdvanced(prop.getLocatorForEnvironment(appUrl,"adfirstname"),prop.getLocatorForEnvironment(appUrl,"adlasttname"),prop.getLocatorForEnvironment(appUrl,"adconsultantid"));
		go2TrainingUsers();
